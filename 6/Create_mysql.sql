...
(
	StudentsID int primary key IDENTITY(1,1) not null,
...
(
	ResultsID int primary key IDENTITY(1,1) not null,
...
alter table Teams add Profession nvarchar(50);
...
alter table Schedules add TeacherID int;
